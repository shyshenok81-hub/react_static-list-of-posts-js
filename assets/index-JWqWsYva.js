...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>$.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({post:e,comments:t,users:i})=>{const{id:n,title:a,body:u,userId:o}=e,r=i.find(m=>m.id===o),s=t.filter(m=>m.postId===n);return $.jsxs("div",{className:"PostInfo",children:[$.jsxs("div",{className:"PostInfo__header",children:[$.jsx("h3",{className:"PostInfo__title",children:a}),$.jsxs("p",{children:[" Posted by ",$.jsx(Pc,{user:r})]})]}),$.jsx("p",{className:"PostInfo__body",children:u}),$.jsx("hr",{}),s.length===0?$.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):$.jsx("div",{className:"CommentList",children:s.map(m=>$.jsxs("div",{className:"CommentInfo",children:[$.jsxs("div",{className:"CommentInfo__title",children:[$.jsx("strong",{className:"CommentInfo__name",children:m.name})," by ",$.jsx("a",{className:"CommentInfo__email",href:`mailto:${m.email}`,children:m.email})]}),$.jsx("div",{className:"CommentInfo__body",children:m.body})]},m.id))})]})},Tc=({posts:e,comments:t,users:i})=>$.jsx("div",{className:"PostList",children:e.map(n=>$.jsx(Lc,{post:n,comments:t,users:i},n.id))}),Mc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx(Tc,{posts:Cc,comments:zc,users:Nc})]});em(document.getElementById("root")).render($.jsx(Mc,{}));
